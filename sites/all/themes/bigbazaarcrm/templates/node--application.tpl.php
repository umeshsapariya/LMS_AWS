<style>
#region-content{ 	color:#000;	text-shadow:none;}
table {
	border: 0;
}
.node-type-application .tabs, .node-type-application #section-header, .node-type-application #page-title{
  display: none;
}
...
<div class="outer_main">
	<table><tr><td style="width:720px;"><form> <input value ="Print this page" type="button" onClick="window.print()"></form></td><td><img src="<?php echo $base_url.'/sites/default/files/logo.jpg'; ?>" alt="Big Bazaar" height="86" width="202"><td></tr></table>
...
<table class="additional" style="width:720px;border-collapse: collapse;">
	<tr>
		<td colspan=2 ><h3 style="float: left;text-align: left;">Applicant details :-</h3></td>
...
<table style="width: 70%;float: left;">
	<tr>
		<td>Existing retailer or trader :</td> <td><?php  if(isset($node->field_existing_retailer_trader[LANGUAGE_NONE][0]['value']) && ($node->field_existing_retailer_trader[LANGUAGE_NONE][0]['value'] == 1)) { echo 'YES'; } else { echo 'No'; } ?></td>
	</tr>
	<tr>
	...
	<tr>
		<td>Involvements of Agency / MLM :</td> <td><?php  if(isset($node->field_involvement_in_agency_mlm[LANGUAGE_NONE][0]['value']) && ($node->field_involvement_in_agency_mlm[LANGUAGE_NONE][0]['value'] == 1)) { echo 'YES'; } else { echo 'No'; } ?></td>
	</tr>
	<tr>
		<td>Leader of any Society, Community or Group :</td> <td><?php  if(isset($node->	field_leader_of_society_commity[LANGUAGE_NONE][0]['value']) && $node->	field_leader_of_society_commity[LANGUAGE_NONE][0]['value'] == 1) { echo 'YES'; } else { echo 'No'; } ?></td>
	</tr>
	<tr>
		<td>Housewife :</td> <td><?php  if(isset($node->field_house_wife[LANGUAGE_NONE][0]['value']) && $node->field_house_wife[LANGUAGE_NONE][0]['value'] == 1) { echo 'YES'; } else { echo 'No'; } ?></td>
	</tr>
	<tr>
...
<table style="width: 70%;float: left;">
	<tr>
		<td> NEON / FLEX Board Size (Inside / Outside):  </td> <td><?php  if(isset($node->field_neon_flex_board_size[LANGUAGE_NONE][0]['value']) && $node->field_neon_flex_board_size[LANGUAGE_NONE][0]['value'] == 1) { echo 'YES'; } else { echo 'No'; } ?></td>
	</tr>
	<tr>
